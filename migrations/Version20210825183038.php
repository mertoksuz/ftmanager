 ...
 */
final class Version20210825183038 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("INSERT INTO `users` (`id`, `username`, `password`, `email`, `is_active`)
VALUES
	(1, 'mert', '$2a$12$2tXW56HTxREZjko/URJdUOjDsCjEMBGTlmPaoF0LzmCMTm9OZROr6', 'mert@linux.com', 0);
");
    }
